...
export function mapEditorLanguage({ schema }: WidgetProps<any, SchemaFormContext>): MonacoEditorProps['language'] {
...
export function mapEditorProps(props: WidgetProps<any, SchemaFormContext>): MonacoEditorProps {
...
export default function EditorWidget(props: WidgetProps<any, SchemaFormContext>) {
