...
function mapTextFieldInputMode({ schema }: WidgetProps<any, SchemaFormContext>): TextFieldProps['inputMode'] {
...
function mapTextFieldInputType({ schema }: WidgetProps<any, SchemaFormContext>): TextFieldProps['type'] {
    const { type, format } = schema;
    switch (type) {
        case 'integer':
...
export function mapTextFieldProps(props: WidgetProps<any, SchemaFormContext>): TextFieldProps {
    return {
...
export default function TextFieldWidget(props: WidgetProps<any, SchemaFormContext>) {
