...
export function mapDateTimePickerProps(props: WidgetProps<any, SchemaFormContext>): TextFieldProps {
...
export default function DateTimePickerWidget(props: WidgetProps<any, SchemaFormContext>) {
